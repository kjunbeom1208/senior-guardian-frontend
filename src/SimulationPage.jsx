...
const VIDEOS = [
  {
    id: 1,
    title: "키오스크 사용법 타파하기",
    desc: " 처음 써도 걱정 없는 키오스크 사용법, 따라 하면 누구나 쉽게 결제 완성!",
    url: "https://www.youtube.com/watch?si=wV2hQkJB84LCxEyB&v=4mo24Bog_P0&feature=youtu.be",
    badge: "영상 1",
  ...
  {
    id: 2,
    title: "AI를 활용한 딥페이크·딥보이스 기술까지",
    desc: "“얼굴·목소리까지 속이는 신기술, 사기 수법으로 악용되지 않게 미리 대비하자!",
    url: "https://www.youtube.com/watch?si=C8he7GJjIysT7k9Q&v=cWoPYfnBBJI&feature=youtu.be",
    badge: "영상 2",
  ...
  {
    id: 3,
    title: "어르신 금융교육 – 인터넷뱅킹 완전정복",
    desc: "은행 갈 필요 없이, 안전하게 계좌이체·조회·납부까지 한 번에 배우는 똑똑한 금융생활!",
    url: "https://www.youtube.com/watch?si=ZFS8QMN3QlJyCpcb&v=jV-lr5rRop0&feature=youtu.be",
    badge: "영상 3",
